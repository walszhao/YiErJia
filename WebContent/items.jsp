			...
			<div class="am-g am-g-fixed">
				<div class="am-u-sm-12 am-u-md-12">
					...
					<ul class="am-pagination am-pagination-right">
						<li><a href="${pageContext.request.contextPath}/SearchServlet?keyWords=${keyWords}&option=item&currentPage=1">首页</a></li>
						<c:if test="${page.currentPage>1}">
							<li><a href="${pageContext.request.contextPath}/SearchServlet?keyWords=${keyWords}&option=item&currentPage=${page.currentPage-1}">上一页</a></li>
						</c:if>
						...
						<c:if test="${page.currentPage<page.totalPage}">
							<li><a href="${pageContext.request.contextPath}/SearchServlet?keyWords=${keyWords}&option=item&currentPage=${page.currentPage+1}">下一页</a></li>
						</c:if>
						
						<li><a href="${pageContext.request.contextPath}/SearchServlet?keyWords=${keyWords}&option=item&currentPage=${page.totalPage}">尾页</a></li>
					</ul>
				</div>
			</div>
		</div>
