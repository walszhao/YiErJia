...
function getData(){
			$('#dg').datagrid({
				url : '${pageContext.request.contextPath}/MgrShopStateServlet',//数据请求地址  
				toolbar: [{  
	                id: 'btnEdit',  
	                text: "查看详情",  
	                iconCls: 'icon-edit',  
...
<body>
<nav> 
<div>首页 <span>&gt;</span> 店铺管理 <span>&gt;</span> 商家审核</div>
	...
	<div class="user-detail">
		<div id="w" class="easyui-window" title="商家详情" data-options="closed:true,iconCls:'icon-save'" style="width:250px;height:250px;padding:10px;">
			<table>
				...
				<tr>
					<td><a id="pick" href="javascript:void(0)" >通过</a></td>
					<td><a id="ban" href="javascript:void(0)" >拒绝</a></td>
				</tr>
			</table>
		</div>
	</div>
